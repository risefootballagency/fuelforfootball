        ...
        <div className="rounded-xl border border-accent/40 bg-card/80 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.35)] px-3 sm:px-4 py-2.5 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium leading-tight">
              {inProgress ? t(portalLanguage, "op_profile_resume_title") : t(portalLanguage, "op_profile_intro_title")}
            </div>
            <div className="text-xs text-muted-foreground truncate">
              {inProgress ? t(portalLanguage, "op_profile_resume_body") : t(portalLanguage, "op_profile_intro_body")}
            </div>
          </div>
