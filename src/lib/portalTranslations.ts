...
const extendedKeys: Record<string, string> = {
  ...
  game_singular: "game",
  game_plural: "games",
  // Comparison tab labels
  scatter_label: "Scatter",
  percentile_label: "Percentile",
  radar_3d_label: "3D Radar",
  player_comparison_label: "Player Comparison",
  scouting_matrix_label: "Scouting Matrix",
  goals_label: "Goals",
  loading_3d_radar: "Loading 3D radar...",
  no_fixture_stats_yet: "No fixture stats recorded yet.",
  no_fixture_stats_detail: "No fixture stats recorded yet. Stats will appear once your performance data is entered.",
  no_comparison_players_for: "No comparison players stored for position:",
  stat_comparison: "Stat Comparison",
  select_players_to_compare: "Select players above to compare stats",
  last_n_avg: "avg",
  request_name: "Request",
  not_enough_players: "Not enough players for comparison matrix.",
  hover_tap_marker: "Hover or tap any marker to reveal player details.",
  position_players: "players",
  not_enough_data_metrics: "Not enough data for the selected metrics. Try different ones.",
  no_comparison_scatter: "No comparison players available for this position.",
  metric_label: "Metric",
  ...
  full_action_report_video: "Full Action Report Video",
  no_clips_match_selection: "No clips match your selection",
  no_clips_available: "No clips available",
  video_reports_loading_clips: "Loading clips...",
  video_reports_no_clips: "No action clips available from your reports.",
  video_reports_step_select_action_types: "Step 1: Select Action Types",
  video_reports_leave_empty_action_types: "Leave empty to include all action types",
  video_reports_step_select_matches: "Step 2: Select Matches",
  notification_pref_performance_reports: "Performance Reports & R90 Scores",
  notification_pref_analyses: "Match Analyses & Concepts",
  notification_pref_programmes: "Training Programmes",
  notification_pref_highlights: "Match Highlights",
  notification_pref_clips: "Video Clips",
  player_summary: "Player Summary",
  name_label: "Name",
  age_label: "Age",
  position_label: "Position",
  club_label: "Club",
  season_r90: "Season R90",
  matches_label: "Matches",
  season_averages: "Season Averages",
  match_by_match: "Match-by-Match",
  season_heatmap_zone_performance: "Season Heat Map & Zone Performance",
  aggregated_latest_reports: "Aggregated from the latest 40 reports.",
  loading_zone_data: "Loading zone data…",
...
const frExtended: Record<string, string> = {
  ...
  game_singular: "match",
  game_plural: "matchs",
  scatter_label: "Nuage de Points",
  percentile_label: "Percentile",
  radar_3d_label: "Radar 3D",
  player_comparison_label: "Comparaison de Joueurs",
  scouting_matrix_label: "Matrice de Scouting",
  goals_label: "Objectifs",
  loading_3d_radar: "Chargement du radar 3D...",
  no_fixture_stats_yet: "Aucune statistique de match enregistrée.",
  no_fixture_stats_detail: "Aucune statistique de match enregistrée. Elles apparaîtront une fois vos données saisies.",
  no_comparison_players_for: "Aucun joueur de comparaison pour le poste :",
  stat_comparison: "Comparaison de Statistiques",
  select_players_to_compare: "Sélectionnez des joueurs ci-dessus pour comparer",
  last_n_avg: "moy.",
  request_name: "Demander",
  not_enough_players: "Pas assez de joueurs pour la matrice de comparaison.",
  hover_tap_marker: "Survolez ou appuyez sur un marqueur pour voir les détails.",
  position_players: "joueurs",
  not_enough_data_metrics: "Pas assez de données pour ces métriques. Essayez-en d'autres.",
  no_comparison_scatter: "Aucun joueur de comparaison disponible pour ce poste.",
  ...
  full_action_report_video: "Vidéo complète du rapport d'actions",
  no_clips_match_selection: "Aucun clip ne correspond à votre sélection",
  no_clips_available: "Aucun clip disponible",
  video_reports_loading_clips: "Chargement des clips...",
  video_reports_no_clips: "Aucun clip d'action disponible depuis vos rapports.",
  video_reports_step_select_action_types: "Étape 1 : Sélectionner les types d'action",
  video_reports_leave_empty_action_types: "Laissez vide pour inclure tous les types d'action",
  video_reports_step_select_matches: "Étape 2 : Sélectionner les matchs",
  notification_pref_performance_reports: "Rapports de performance et scores R90",
  notification_pref_analyses: "Analyses de match et concepts",
  notification_pref_programmes: "Programmes d'entraînement",
  notification_pref_highlights: "Moments forts des matchs",
  notification_pref_clips: "Clips vidéo",
  player_summary: "Résumé du joueur",
  name_label: "Nom",
  age_label: "Âge",
  position_label: "Poste",
  club_label: "Club",
  season_r90: "R90 de saison",
  matches_label: "Matchs",
  season_averages: "Moyennes de saison",
  match_by_match: "Match par match",
  season_heatmap_zone_performance: "Carte de chaleur saisonnière et performance par zone",
  aggregated_latest_reports: "Agrégé à partir des 40 derniers rapports.",
  loading_zone_data: "Chargement des données de zone…",
...
const csExtended: Record<string, string> = {
  ...
  full_action_report_video: "Video celého reportu akcí",
  no_clips_match_selection: "Výběru neodpovídají žádné klipy",
  no_clips_available: "Žádné klipy nejsou k dispozici",
  video_reports_loading_clips: "Načítání klipů...",
  video_reports_no_clips: "Z vašich reportů nejsou dostupné žádné klipy akcí.",
  video_reports_step_select_action_types: "Krok 1: Vyberte typy akcí",
  video_reports_leave_empty_action_types: "Nechte prázdné pro všechny typy akcí",
  video_reports_step_select_matches: "Krok 2: Vyberte zápasy",
  notification_pref_performance_reports: "Reporty výkonnosti a skóre R90",
  notification_pref_analyses: "Zápasové analýzy a koncepty",
  notification_pref_programmes: "Tréninkové programy",
  notification_pref_highlights: "Zápasové highlights",
  notification_pref_clips: "Video klipy",
  player_summary: "Souhrn hráče",
  name_label: "Jméno",
  age_label: "Věk",
  position_label: "Pozice",
  club_label: "Klub",
  season_r90: "Sezónní R90",
  matches_label: "Zápasy",
  season_averages: "Sezónní průměry",
  match_by_match: "Zápas po zápase",
  season_heatmap_zone_performance: "Sezónní heatmapa a výkon zón",
  aggregated_latest_reports: "Agregováno z posledních 40 reportů.",
  loading_zone_data: "Načítání dat zón…",
  no_zone_data_latest_reports: "V posledních 40 reportech nejsou data zón.",
  r90_distribution: "Rozložení R90",
  performance_radar: "Radar výkonnosti",
  scatter_label: "Bodový graf",
  percentile_label: "Percentil",
  radar_3d_label: "3D Radar",
  player_comparison_label: "Srovnání hráčů",
  scouting_matrix_label: "Scoutingová matice",
  goals_label: "Cíle",
  loading_3d_radar: "Načítání 3D radaru...",
  no_fixture_stats_yet: "Zatím žádné statistiky ze zápasů.",
  no_fixture_stats_detail: "Zatím žádné statistiky. Zobrazí se po zadání dat.",
  no_comparison_players_for: "Žádní hráči k porovnání pro pozici:",
  stat_comparison: "Porovnání statistik",
  select_players_to_compare: "Vyberte hráče výše pro porovnání",
  last_n_avg: "prům.",
  request_name: "Požádat o",
  not_enough_players: "Nedostatek hráčů pro srovnávací matici.",
  hover_tap_marker: "Najeďte nebo klepněte na značku pro zobrazení detailů.",
  position_players: "hráči",
  not_enough_data_metrics: "Nedostatek dat pro vybrané metriky. Zkuste jiné.",
  no_comparison_scatter: "Pro tuto pozici nejsou dostupní hráči k porovnání.",
  metric_label: "Metrika",
};
